...
Employee::Employee(QString name_E, QString address_E, QString contact_E)
{
    this->name_E = name_E;
...
{
    QSqlQuery query;
    query.prepare("INSERT INTO Employee (name_E, address_E, contact_E)"
                  "VALUES (:name_E, :address_E, :contact_E)");
...
// modifier
bool Employee::update(int id, QString name_E, QString address_E, QString contact_E)
{
    QSqlQuery query;
    query.prepare("UPDATE Employee SET name_E = (?), address_E = (?), contact_E = (?) WHERE id_E = (?)");
